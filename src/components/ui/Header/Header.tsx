...
export const Header = () => {
  ...
  return (
    <>
      ...
      >
        <div className="mx-auto h-full w-full max-w-6xl flex items-center justify-between gap-5">
          ...
          <div className="flex items-center min-w-fit">
            ...
            {isLoggedIn ? (
              ...
              <div className="flex gap-2 w-40 items-center">
                ...
                <button
                  className="flex-1 bg-blue-600 text-white px-3 py-1 rounded text-sm text-nowrap font-bold"
